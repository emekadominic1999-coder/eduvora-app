...
-- =============================================================================
-- ADDENDUM — emoji reactions and photo/document sharing
-- =============================================================================
-- Added after the first release of this file. See GROUPS_reactions_and_uploads.sql
-- for the same content as a standalone file, if you already ran everything above
-- and just want the addendum.
