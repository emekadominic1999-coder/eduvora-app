...
PRIVACY = dict(
    ...
    sections=[
        ...
        ('What we collect', [], [
            ...
            'Last-seen time: the last time you had the app open. We use it only to count how many students are active, and the count is seen only by the Eduvora owner.',
        ]),
        ('How we use it', [], [
